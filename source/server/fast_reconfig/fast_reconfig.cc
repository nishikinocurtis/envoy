...
FastReconfigServerImpl::FastReconfigServerImpl(Server::Instance& server,
    ...
    : server_(server),
      ...
      cluster_reconfig_handler_instance_(server_,
                                         std::move(cluster_reconfig_callback),
                                         std::move(cluster_reconfig_resource_decoder)),
      replicate_recover_handler_instance_(server_,
                                          std::move(storage_manager)),
      endpoint_reconfig_handler_instance_(),
      handler_registry_({
        {"/rr_listener", registerHandler(HANDLER_WRAPPER(listener_reconfig_handler_instance_.pushNewListenersHandler))},
        {"/rr_cluster", registerHandler(HANDLER_WRAPPER(cluster_reconfig_handler_instance_.pushNewClusterInfo))},
        ...
        {"/rr_endpoint", registerHandler(HANDLER_WRAPPER(endpoint_reconfig_handler_instance_.pushNewEndpointInfo))}}),
